...
@interface BFAllChallengesViewController ()

@end

@implementation BFAllChallengesViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [_enrollToEventLabel setHidden:TRUE];
    [_enrollButton setHidden:TRUE];
    ...
    if(status == NO){
        ...
        UIAlertAction *cancelActionButton = [UIAlertAction
                                            ...
                                            handler:^(UIAlertAction *action){
                                                ...
                                                [_enrollToEventLabel setHidden:FALSE];
                                                [_enrollButton setHidden:FALSE];
                                             }];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.thumbimage.layer.cornerRadius = 20;
